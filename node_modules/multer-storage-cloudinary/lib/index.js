...
var CloudinaryStorage = /** @class */ (function () {
    ...
    CloudinaryStorage.prototype._handleFile = function (req, file, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var uploadOptions, _a, public_id, otherParams, _b, untypedKey, key, getterOrValue, value, resp, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        uploadOptions = (_b.public_id = _c.sent(), _b);
                        for (untypedKey in otherParams) {
                            key = untypedKey;
                            getterOrValue = otherParams[key];
                            value = typeof getterOrValue === 'function'
                                ? getterOrValue(req, file)
                                : getterOrValue;
                            uploadOptions[key] = value;
                        }
                        _c.label = 4;
                    case 4: return [4 /*yield*/, this.upload(uploadOptions, file)];
                    case 5:
                        resp = _c.sent();
                        callback(undefined, {
